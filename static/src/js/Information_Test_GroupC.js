...
const groupC_questionList = [
    ...
    "2-1. 가장 큰 소리는 무엇인가요? 📣 ",
    "2-2. 가장 큰 소리는 무엇인가요? 🎨",
    "3-1. 소리가 점점 높아지는 멜로디는 무엇인가요? 📣 ",
    "3-2. 소리가 점점 높아지는 멜로디는 무엇인가요? 🎨",
    "4-1. 소리가 점점 커지는 멜로디는 무엇인가요? 📣 ",
    "4-2. 소리가 점점 커지는 멜로디는 무엇인가요? 🎨",
    "5-1. 소리가 점점 빨라지는 멜로디는 무엇인가요? 📣 ",
    "5-2. 소리가 점점 빨라지는 멜로디는 무엇인가요? 🎨",
    "6-1. 소리가 점점 작아지면서 음이 내려가는 멜로디는 무엇인가요? 📣 ",
    "6-2. 소리가 점점 작아지면서 음이 내려가는 멜로디는 무엇인가요? 🎨",
    "7-1. 소리가 점점 느려지면서 음이 내려가는 멜로디는 무엇인가요? 📣 ",
    "7-2. 소리가 점점 느려지면서 음이 내려가는 멜로디는 무엇인가요? 🎨",
    "8-1. 소리가 점점 작아지면서 음이 빨라지는 멜로디는 무엇인가요? 📣 ",
    "8-2. 소리가 점점 작아지면서 음이 빨라지는 멜로디는 무엇인가요? 🎨",
    "9-1. 소리의 음이 가장 적게 변화되는 멜로디는 무엇인가요? 📣 ",
    "9-2. 소리의 음이 가장 적게 변화되는 멜로디는 무엇인가요? 🎨",
    "테스트가 끝났습니다."
]
...
function submit_groupC(){
    groupC_submit.addEventListener("click", () => {
        LogData.push("Timestamp#"+(Date.now()-startTime).toString()+"#Action#"+"Submit#"+groupC_count.toString())
        groupC_count += 1
        if(groupC_count==18){
            console.log(LogData);
            groupC_question.innerText = groupC_questionList[18]
            ...
            // postdata
        }else if(groupC_count>18){
            console.log("You Should Not Encounter This State.")
        }else{
        SelectedQuestion = Math.floor(groupC_count/2)
...
function UpdateTaskSheet(){
    if(SelectedAnswer!=4){
        ...
        TaskSheet = SetC[SelectedQuestion][SelectedAnswer-1];
